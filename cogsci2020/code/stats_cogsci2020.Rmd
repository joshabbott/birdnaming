...
Fig 5 in current draft suggests that species with monomial names are more frequent than species with compound names, but I'm seeing the opposite here -- the effect goes in the opposite way than what we might predict.
Did one of us swap codes for compound and monomial?
...
Coefficients suggest that logfreq (0.63) is a stronger predictor than logmass (-0.04). Dropping logfreq produces a model that's significantly worse (p < 3e-13) but dropping logmass doesn't (p = 0.60). AIC scores support same conclusion.

## Name length

Suggest not including a figure for this, but just reporting in the text. Effect of frequency goes in the same way as for the compound vs monomial analysis (more common things have longer names)
