...
% XXX: report linear regressions in full (including coefficients). also report hypothesis tests in full. acknowledge that category size variable is coupled across species -- all members of the same folk-genericcategory have the same value
