...
The scientific species labels used by our three sources of data (eBird, EltonTraits and Hunn's taxonomy) do not always match. We took the Clements checklist (used by eBird) as our gold standard, and some manual preprocessing was required to align the eBird labels with the labels used by our other two resources. 


\section{Analysis of category extensions}

We focus first on the extensions of folk categories, and subsequently consider the labels or names given to these categories. 

\section{Named vs unnamed species}
